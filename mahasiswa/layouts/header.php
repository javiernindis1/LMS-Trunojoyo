...
// Determine role path based on URL
$rolePath = '';
if (strpos($_SERVER['REQUEST_URI'], '/mahasiswa/') !== false) {
    $rolePath = 'dosen/';
} elseif (strpos($_SERVER['REQUEST_URI'], '/mahasiswa/') !== false) {
    $rolePath = 'mahasiswa/';
} else {
    $rolePath = 'dosen/'; // default
}
?>
<!DOCTYPE html>
<html lang="id">
...
<nav class="navbar navbar-expand navbar-dark lms-navbar" id="mainNavbar">
    ...
    <a class="navbar-brand navbar-logo-wrap" href="<?= BASE_URL ?>">
        <img src="<?= BASE_URL ?>/mahasiswa/public/img/logo.png" alt="Logo Sekolah" class="navbar-logo" 
    ...
    <ul class="navbar-nav navbar-nav-center">
        ...
        foreach ($navItems as $item):
            ...
            $href = BASE_URL . '/' . 'mahasiswa/' . $item['page'];
    ...
    <aside class="lms-sidebar">
        ...
        <div class="sidebar-profile-card">
            <div class="profile-avatar-wrap">
                <img src="<?= BASE_URL ?>/mahasiswa/public/img/avatar.png" alt="Avatar"
                     onerror="this.style.display='none'; this.nextElementSibling.style.display='flex';">
            ...
            <div class="profile-info text-center mt-2">
                ...
                <p class="profile-nip">NIM di sini</p>
        ...
        <div class="sidebar-kelas-card">
            ...
            <ul class="kelas-list list-unstyled mb-0">
                <?php foreach ($kelasList as $kelas): 
                    ...
                    $kelasUrl = BASE_URL . '/' . 'mahasiswa/' . $currentPage . '?kelas_id=' . $kelas['id'];
                ?>
