...
<div class="detail-card">
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="detail-text fw-bold"><?= htmlspecialchars($tugas['judul']) ?></div>
        </div>

        <div class="col-md-6 mt-3">
            <div class="detail-label">Tenggat Waktu</div>
            <div class="detail-text"><?= htmlspecialchars($tugas['tenggat']) ?></div>
        </div>

        <div class="col-md-6">
            <div class="detail-label">Deskripsi</div>
            <div class="detail-text"><?= htmlspecialchars($tugas['deskripsi']) ?></div>
        </div>

        <div class="col-md-6 mt-3">
            <div class="detail-label">Poin</div>
            <div class="detail-text"><?= htmlspecialchars($tugas['poin']) ?></div>
        </div>
        <div class="col-md-6 mt-3">
